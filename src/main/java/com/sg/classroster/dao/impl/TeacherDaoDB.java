...
public class TeacherDaoDB implements TeacherDao {
	...
	public Teacher addTeacher(Teacher teacher) {
		...
		jdbcTemplate.update(INSERT_TEACHER, teacher.getFirstName(), teacher.getLastName(), teacher.getSpecialty());
	...
	public void updateTeacher(Teacher teacher) {
		...
		jdbcTemplate.update(UPDATE_TEACHER, teacher.getFirstName(), teacher.getLastName(), teacher.getSpecialty(),
				teacher.getId());
	}
